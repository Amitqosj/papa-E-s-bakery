  ...
  return (
    <footer className="border-t border-cocoa/8 bg-cream px-4 pb-28 pt-14 min-[375px]:px-5 sm:px-8 sm:pb-20 sm:pt-16 lg:pb-16">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-10 sm:gap-12 md:grid-cols-[1.2fr_1fr_0.8fr]">
          <div className="min-w-0">
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-cocoa-soft">
              {brand.tagline}
            </p>
          </div>

          <nav aria-label="Footer">
            <p className="mb-4 text-xs font-medium uppercase tracking-[0.18em] text-rose">
              Explore
            </p>
